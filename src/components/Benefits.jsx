    ...
    <div className="py-8 px-4 mx-auto max-w-screen md:m-8 lg:py-16 lg:px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
            ...
            <article className="p-6 bg-white  border border-gray-200 dark:hover:shadow-sky-400 shadow-xl dark:bg-gray-800  rounded-lg  dark:border-gray-700 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 hover:bg-sky-300 duration-300">
                <div className="flex justify-between items-center mb-5 text-gray-500">
                    <span className="bg-primary-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">
                        <svg className="mr-1 w-3 h-3" fill="currentColor" viewBox="0 0 20 20" ><path fillRule="evenodd" d="M2 5a2 2 0 012-2h8a2 2 0 012 2v10a2 2 0 002 2H4a2 2 0 01-2-2V5zm3 1h6v4H5V6zm6 6H5v2h6v-2z" clipRule="evenodd"></path><path d="M15 7h1a2 2 0 012 2v5.5a1.5 1.5 0 01-3 0V7z"></path></svg>
                        Article
                    </span>
